...
Public Class FormMisPlaylist
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Dim nombrePlaylist As String = listaPlaylist.SelectedItem.ToString()
        ...
        Try
            ...
            Do While MiLector.Read()
                ...
                lbNombre.Text = MiLector.GetString(1)
                lbFecha.Text = MiLector.GetValue(2).ToString()
    ...
    Sub ActualizarPlaylists()
        ...
        Try
            ...
            Do While MiLector.Read()
                ...
                listaPlaylist.Items.Add(nombrePlaylist)
            Loop
    ...
    Sub ActualizarCanciones()
        ...
        Dim nombrePlaylist1 As String = listaPlaylist.SelectedItem.ToString()
        ...
        Try
            ...
            Do While MiLector.Read()
                ...
                listaCanciones.Items.Add(nombreCancion)
            Loop
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        Dim cancionSeleccionada As String = listaCanciones.SelectedItem()
